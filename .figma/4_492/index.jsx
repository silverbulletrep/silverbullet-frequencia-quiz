    ...
    <div className={styles.httpsSignupSpiriohub}>
      <div className={styles.component12}>
        ...
        <div className={styles.component1}>
          <img src="../image/mg6tnbk9-zguo9rj.svg" className={styles.variant14} />
          <img src="../image/mg6tnbk9-j5sc3k5.svg" className={styles.variant22} />
          <img src="../image/mg6tnbk9-38qdtge.svg" className={styles.variant3} />
        </div>
      </div>
    </div>
  );
